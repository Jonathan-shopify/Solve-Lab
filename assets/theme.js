function addElements() {
  const targetElement = document.querySelector('.yotpo-selling-plan-select-container');
          ...
          const subTextIcons = [
            ...
            { text: 'Mushroom gift with every 5th subscription' }
          ];
...
<g clip-path="url(#clip0_2472_1116)">
<g clip-path="url(#clip1_2472_1116)">
<path d="M8.13308 0.193359H7.80718C3.49539 0.193359 0 3.68875 0 8.00054V8.00058C0 12.3124 3.49539 15.8078 7.80718 15.8078H8.13308C12.4449 15.8078 15.9403 12.3124 15.9403 8.00058V8.00054C15.9403 3.68875 12.4449 0.193359 8.13308 0.193359Z" fill="url(#paint0_linear_2472_1116)"/>
<path d="M3.94531 7.49788L7.17934 10.3743L10.1824 3.58594" stroke="url(#paint1_linear_2472_1116)" stroke-width="1.77778"/>
</g>
</g>
<defs>
<linearGradient id="paint0_linear_2472_1116" x1="7.97011" y1="0.193359" x2="7.97011" y2="15.8078" gradientUnits="userSpaceOnUse">
<stop stop-color="#585858"/>
</linearGradient>
<linearGradient id="paint1_linear_2472_1116" x1="7.06384" y1="3.58594" x2="7.06384" y2="10.3743" gradientUnits="userSpaceOnUse">
<stop stop-color="white"/>
</linearGradient>
<clipPath id="clip0_2472_1116">
<rect width="16" height="16" fill="white"/>
</clipPath>
<clipPath id="clip1_2472_1116">
<rect width="16" height="16" fill="white"/>
</clipPath>
</defs>
</svg>
 ...
 $(".yotpo-radio-and-dropdown-label").each(function() {
    // Get the current text of the label
    var currentText = $(this).text();
    // Remove the '(20% off)' part
    var newText = currentText.replace(/\s*\(20% off\)/, '');
    // Set the new text
    $(this).text(newText);
  });
          ...
          const targetElement_2 = document.querySelector('.yotpo-radio-container.yotpo-radio-subscription-container ');
          ...
          new_Div.className = 'sub-head';
          const p = document.createElement('p');
          p.textContent = 'Save 20%';
          new_Div.appendChild(p);
          targetElement_2.insertAdjacentElement('afterbegin', new_Div);

}


const interval2 = setInterval(() => {
  if($('.yotpo-radio-subscription-container').length > 0){
    addElements();  
    clearInterval(interval2);
  }
 }, 1000); 

// Add event listener to .variant_wrap input elements
document.addEventListener('click', (event) => {
  if (event.target.closest('.variant_wrap input')) {
...
theme.icons = {
  ...
  product_right:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 10 19" role="presentation"><path d="m1 1 7.808 7.808a.61.61 0 0 1 0 .888L1 17.504" stroke="#a7a7a7" stroke-width="2" fill="none" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round"></path></svg>',
  product_left:'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 10 19" role="presentation"><path d="M9 1 1.192 8.808a.61.61 0 0 0 0 .888L9 17.504" stroke="#a7a7a7" stroke-width="2" fill="none" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round"></path></svg>'
};
  ...
  $formContainer.find('form.product-purchase-form').each(function() {
    ...
    $form.on('submit', function (evt) {
      ...
      if(theme.settings.after_add_to_cart !== 'no-js' && $formContainer.is('[data-ajax-add-to-cart="true"]')) {
        ...
        $form.find('#add-cart-btn').addClass('loading');
        console.log('ADDDED THIS ONE IS cliked', $form)
        ...
        $.post(shopifyAjaxAddURL, new URLSearchParams(formData).toString(), theme.addedToCartHandler.bind($form), 'json').fail(function(data) {
          ...
          $('#sticky-product-button').removeClass('loading');
          ...
          if (typeof (data) !== 'undefined' && typeof (data.status) !== 'undefined') {
            ...
            $formContainer.find('#add-cart-btn-error-message').html(error);
            setTimeout(function(){
              $formContainer.find('#add-cart-btn-error-message').html('');
            },6000);
...
theme.initProductGallery = function(container){
  ...
  if($slideshow.length) {
    const slickConfig = {
      ...
      prevArrow: '<button type="button" class="slick-prev" aria-label="'+theme.strings.previous+'">'+theme.icons.product_left+'</button>',
      nextArrow: '<button type="button" class="slick-next" aria-label="'+theme.strings.next+'">'+theme.icons.product_right+'</button>',
      mobileFirst: true,
...
// end for intg page
  ...
  $('div#shopify-section-template--23013974442293__featured_collection_fB7eQR').addClass('inactive_collection');
  $('div#shopify-section-template--23013974442293__featured_collection_kFUAdG').addClass('inactive_collection');
  $('div#shopify-section-template--23013974442293__featured_collection_4AMYwp').addClass('inactive_collection');
  ...
  $(".collection_tab_item").click(function(){
    ...
    if( collection_name == 'filtertab-1' ){  
      $('div#shopify-section-template--23013974442293__featured_collection_zyeget').removeClass('inactive_collection');
      ...
      $('div#shopify-section-template--23013974442293__featured_collection_fB7eQR').removeClass('inactive_collection');
      
      $('div#shopify-section-template--23013974442293__featured_collection_zyeget').addClass('inactive_collection');
      $('div#shopify-section-template--23013974442293__featured_collection_kFUAdG').addClass('inactive_collection');
      $('div#shopify-section-template--23013974442293__featured_collection_4AMYwp').addClass('inactive_collection');
    }
      
    else if( collection_name == 'filtertab-3' ){
      $('div#shopify-section-template--23013974442293__featured_collection_kFUAdG').removeClass('inactive_collection');
     ...
     else if( collection_name == 'filtertab-4' ){
      $('div#shopify-section-template--23013974442293__featured_collection_4AMYwp').removeClass('inactive_collection');
